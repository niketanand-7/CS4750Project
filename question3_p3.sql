...
-- INSERT INTO submits (email, applicationId, createdDate)
-- VALUES
-- ( 'alice.smith@example.com', 1, '2023-04-15'),
-- ( 'alice.smith@example.com', 2, '2023-04-20'),
-- ( 'alice.smith@example.com', 3, '2023-04-25'),
-- ( 'bob.johnson@example.com', 4, '2023-04-16'),
-- ( 'bob.johnson@example.com', 5, '2023-04-22'),
-- ( 'bob.johnson@example.com', 6, '2023-04-28'),
-- ( 'carol.williams@example.com', 7, '2023-04-17'),
-- ( 'carol.williams@example.com', 8, '2023-04-23'),
-- ( 'carol.williams@example.com', 9, '2023-04-29'),
-- ( 'dave.brown@example.com', 10, '2023-04-18'),
-- ( 'dave.brown@example.com', 11, '2023-04-24'),
-- ( 'eva.jones@example.com', 12, '2023-04-19'),
-- ( 'eva.jones@example.com', 13, '2023-04-25'),
-- ( 'eva.jones@example.com', 14, '2023-05-01'),
-- ( 'frank.miller@example.com', 15, '2023-04-20'),
-- ( 'frank.miller@example.com', 16, '2023-04-26'),
-- ( 'grace.davis@example.com', 17, '2023-04-21'),
-- ( 'grace.davis@example.com', 18, '2023-04-27'),
-- ( 'grace.davis@example.com', 19, '2023-05-03'),
-- ( 'henry.garcia@example.com', 20, '2023-04-22'),
-- ( 'henry.garcia@example.com', 21, '2023-04-28'),
-- ( 'henry.garcia@example.com', 22, '2023-05-04'),
-- ( 'irene.martinez@example.com', 23, '2023-04-23'),
-- ( 'irene.martinez@example.com', 24, '2023-04-29'),
-- ( 'jack.taylor@example.com', 25, '2023-04-24'),
-- ( 'jack.taylor@example.com', 26, '2023-04-30'),
-- ( 'karen.anderson@example.com', 27, '2023-04-25'),
-- ( 'karen.anderson@example.com', 28, '2023-05-01'),
-- ( 'karen.anderson@example.com', 29, '2023-05-07'),
-- ( 'leo.thomas@example.com', 30, '2023-04-26'),
-- ( 'leo.thomas@example.com', 31, '2023-05-02'),
-- ( 'leo.thomas@example.com', 32, '2023-05-08'),
-- ( 'mary.moore@example.com', 33, '2023-04-27'),
-- ( 'mary.moore@example.com', 34, '2023-05-03'),
-- ( 'mary.moore@example.com', 35, '2023-05-09'),
-- ( 'nathan.jackson@example.com', 36, '2023-04-28'),
-- ( 'nathan.jackson@example.com', 37, '2023-05-04'),
-- ( 'olivia.white@example.com', 38, '2023-04-29'),
-- ( 'olivia.white@example.com', 39, '2023-05-05'),
-- ( 'olivia.white@example.com', 40, '2023-05-11'),
-- ( 'peter.harris@example.com', 41, '2023-04-30'),
-- ( 'peter.harris@example.com', 42, '2023-05-06'),
-- ( 'queen.lewis@example.com', 43, '2023-05-01'),
-- ( 'queen.lewis@example.com', 44, '2023-05-07'),
-- ( 'robert.clark@example.com', 45, '2023-05-02'),
-- ( 'robert.clark@example.com', 46, '2023-05-08'),
-- ( 'robert.clark@example.com', 47, '2023-05-14'),
-- ( 'susan.robinson@example.com', 48, '2023-05-03'),
-- ( 'susan.robinson@example.com', 49, '2023-05-09'),
-- ( 'timothy.walker@example.com', 50, '2023-05-04'),
-- ( 'timothy.walker@example.com', 51, '2023-05-10'),
-- ( 'ursula.young@example.com', 52, '2023-05-05'),
-- ( 'ursula.young@example.com', 53, '2023-05-11'),
-- ( 'ursula.young@example.com', 54, '2023-05-17'),
-- ( 'victor.king@example.com', 55, '2023-05-06'),
-- ( 'victor.king@example.com', 56, '2023-05-12'),
-- ( 'wendy.wright@example.com', 57, '2023-05-07'),
-- ( 'wendy.wright@example.com', 58, '2023-05-13'),
-- ( 'wendy.wright@example.com', 59, '2023-05-19'),
-- ( 'xavier.lopez@example.com', 60, '2023-05-08'),
-- ( 'xavier.lopez@example.com', 61, '2023-05-14'),
-- ( 'yvonne.hill@example.com', 62, '2023-05-09'),
-- ( 'yvonne.hill@example.com', 63, '2023-05-15'),
-- ( 'zachary.scott@example.com', 64, '2023-05-10'),
-- ( 'zachary.scott@example.com', 65, '2023-05-16'),
-- ( 'amelia.green@example.com', 66, '2023-05-11'),
-- ( 'amelia.green@example.com', 67, '2023-05-17'),
-- ( 'brian.adams@example.com', 68, '2023-05-12'),
-- ( 'brian.adams@example.com', 69, '2023-05-18'),
-- ( 'brian.adams@example.com', 70, '2023-05-24'),
-- ( 'claire.baker@example.com', 71, '2023-05-13'),
-- ( 'claire.baker@example.com', 72, '2023-05-19'),
-- ( 'daniel.gonzalez@example.com', 73, '2023-05-14'),
-- ( 'daniel.gonzalez@example.com', 74, '2023-05-20'),
-- ( 'emma.nelson@example.com', 75, '2023-05-15'),
-- ( 'emma.nelson@example.com', 76, '2023-05-21'),
-- ( 'fred.carter@example.com', 77, '2023-05-16'),
-- ( 'fred.carter@example.com', 78, '2023-05-22'),
-- ( 'gina.mitchell@example.com', 79, '2023-05-17'),
-- ( 'gina.mitchell@example.com', 80, '2023-05-23'),
-- ( 'gina.mitchell@example.com', 81, '2023-05-29'),
-- ( 'harry.perez@example.com', 82, '2023-05-18'),
-- ( 'harry.perez@example.com', 83, '2023-05-24'),
-- ( 'isabella.roberts@example.com', 84, '2023-05-19'),
-- ( 'isabella.roberts@example.com', 85, '2023-05-25'),
-- ( 'isabella.roberts@example.com', 86, '2023-05-31');
